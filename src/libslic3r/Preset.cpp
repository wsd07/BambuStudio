...
static std::vector<std::string> s_Preset_print_options {
    ...
    "smooth_speed_discontinuity_area","smooth_coefficient", "seam_position", "seam_optimization", "seam_placement_away_from_overhangs", "wall_sequence", "is_infill_first", "sparse_infill_density", "fill_multiline",
    ...
    "brim_width", "brim_object_gap", "brim_layers", "brim_type", "enable_support", "support_type", "support_threshold_angle", "enforce_support_layers",
